...
public class EditArticlesPanel extends javax.swing.JPanel {
    ...
    private void btnDeleteAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAllActionPerformed
        try {
            RepositoryFactory.getRepository().deleteAllNewspapers();
            RepositoryFactory.getRepository().deleteAllArticles();
            RepositoryFactory.getRepository().deleteAllJournalists();
            TableModel table = new DefaultTableModel();
            tbArticles.setModel(table);
